...
class View(QGraphicsView):
    def __init__(self) -> None:
        ...
        self.series.clicked.connect(self.keep_callout)  # type: ignore
        self.series.hovered.connect(self.tooltip)  # type: ignore

        self.series2.clicked.connect(self.keep_callout)  # type: ignore
        self.series2.hovered.connect(self.tooltip)  # type: ignore
    ...
    def keep_callout(self) -> None:
        self._callouts.append(self._tooltip)
        self._tooltip = Callout(self._chart)

    def tooltip(self, point: QPointF, state: bool) -> None:
